    ...
    class Day02
    {
        ...
        public static int Part1()
        {
            ...
            for (int x = 0; x < input.GetLength(0); ++x)
            {
                ...
                {
                    lowestValue = (input[x, y] < lowestValue) ? input[x, y] : lowestValue;
                    highestValue = (input[x, y] > highestValue) ? input[x, y] : highestValue;
                }
        ...
        public static int Part2()
        {
            ...
            for (int x = 0; x < input.GetLength(0); ++x)
            {
                for (int y = 0; y < input.GetLength(1); ++y)
                {
                    for (int z = y; z < input.GetLength(1); ++z)
                    {
                        if (y != z)
                        {
                            float n1 = input[x, y];
